    ...
    <footer className="bg-gray-50 border-t">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Origami World</h3>
            <p className="text-gray-600 text-sm">
              Your journey into the art of paper folding starts here.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tutorials" className="text-gray-600 hover:text-blue-600 text-sm">
                  Tutorials
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} Origami World. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
